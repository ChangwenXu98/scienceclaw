...
print(f"Starting UMA relaxation for ScH6")
...
opt = BFGS(atoms, trajectory='ScH6_relaxation.traj')
opt.run(fmax=0.05, steps=200)

# Save relaxed structure
write('ScH6_relaxed.cif', atoms, format='cif')
write('ScH6_relaxed_POSCAR', atoms, format='vasp')
...
print(f"Relaxation completed for ScH6")
print(f"Final energy: {final_energy:.6f} eV")
print(f"Final volume: {final_volume:.3f} Å³")
print(f"Final stress: {final_stress}")

# Save results
with open('ScH6_relaxation_results.txt', 'w') as f:
    f.write(f"Compound: ScH6
")
...
print(f"Results saved to ScH6_relaxation_results.txt")
